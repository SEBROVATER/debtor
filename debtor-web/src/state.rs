...
pub struct AppState {
    ...
    /// Root-owned definitive Group mutation executor.
    pub group_mutations: Arc<dyn GroupMutationExecutor>,
    ...
    /// Current-month source-summary workflow.
    pub summaries: Arc<dyn SummaryUseCases>,
